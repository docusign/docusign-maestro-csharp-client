...
namespace DocuSign.Maestro.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DSWorkflowLastIndexOfExpression :  IEquatable<DSWorkflowLastIndexOfExpression>, IValidatableObject
    {
        public DSWorkflowLastIndexOfExpression()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DSWorkflowLastIndexOfExpression" /> class.
        /// </summary>
        ...
        public DSWorkflowLastIndexOfExpression(Object SearchText = default(Object), Object Text = default(Object), DSWorkflowTransformationExpressionTypesLastIndexOfExpression Type = default(DSWorkflowTransformationExpressionTypesLastIndexOfExpression))
        {
            // to ensure "SearchText" is required (not null)
            if (SearchText == null)
            {
                throw new InvalidDataException("SearchText is a required property for DSWorkflowLastIndexOfExpression and cannot be null");
            }
            else
            {
            ...
            if (Text == null)
            {
                throw new InvalidDataException("Text is a required property for DSWorkflowLastIndexOfExpression and cannot be null");
            }
            else
            {
                this.Text = Text;
            ...
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for DSWorkflowLastIndexOfExpression and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public DSWorkflowTransformationExpressionTypesLastIndexOfExpression Type { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DSWorkflowLastIndexOfExpression);
        }

        /// <summary>
        /// Returns true if DSWorkflowLastIndexOfExpression instances are equal
        /// </summary>
        /// <param name="other">Instance of DSWorkflowLastIndexOfExpression to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DSWorkflowLastIndexOfExpression other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
